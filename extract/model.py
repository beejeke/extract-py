...
class CamdexData(db.Model):
    ...
    mmse = db.Column(db.String(40), unique=False)
    mec = db.Column(db.String(40), unique=False)
    ryh = db.Column(db.String(40), unique=False)
    ct = db.Column(db.String(40), unique=False)
    ori = db.Column(db.String(40), unique=False)
    lt = db.Column(db.String(40), unique=False)
    lc = db.Column(db.String(40), unique=False)
    lp = db.Column(db.String(40), unique=False)
    mt = db.Column(db.String(40), unique=False)
    mrec = db.Column(db.String(40), unique=False)
    mrem = db.Column(db.String(40), unique=False)
    ma = db.Column(db.String(40), unique=False)
    ac = db.Column(db.String(40), unique=False)
    pr = db.Column(db.String(40), unique=False)
    cal = db.Column(db.String(40), unique=False)
    pabs = db.Column(db.String(40), unique=False)
    ptv = db.Column(db.String(40), unique=False)