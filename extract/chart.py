...
class Trace(MergeableDict):
    template = dict(fill="tozeroy", type="scatter")
...
class MMSEGraph(XYGraph):
    def __init__(self, x, y, *args, **kwargs):
        ...
        self["data"][0]["line"] = {"color": "rgb(230,138,0)"}
...
class MECGraph(XYGraph):
    def __init__(self, x, y, *args, **kwargs):
        ...
        self["data"][0]["line"] = {"color": "rgb(102,0,204)"}
...
class RYHGraph(XYGraph):
    def __init__(self, x, y, *args, **kwargs):
        ...
        self["data"][0]["line"] = {"color": "rgb(56,131,128)"}
...
class CTGraph(XYGraph):
    def __init__(self, x, y, *args, **kwargs):
        ...
        self["data"][0]["line"] = {"color": "rgb(153,50,50)"}
...
class ORIGraph(XYGraph):
    def __init__(self, x, y, *args, **kwargs):
        ...
        self["data"][0]["line"] = {"color": "rgb(218,213,72)"}
...
class LTGraph(XYGraph):
    def __init__(self, x, y, *args, **kwargs):
        ...
        self["data"][0]["line"] = {"color": "rgb(28,79,3)"}
...
class LCGraph(XYGraph):
    def __init__(self, x, y, *args, **kwargs):
        ...
        self["data"][0]["line"] = {"color": "rgb(140,186,115)"}
...
class LPGraph(XYGraph):
    def __init__(self, x, y, *args, **kwargs):
        ...
        self["data"][0]["line"] = {"color": "rgb(48,121,8)"}
...
class MTGraph(XYGraph):
    def __init__(self, x, y, *args, **kwargs):
        ...
        self["data"][0]["line"] = {"color": "rgb(0,72,79)"}
...
class MRECGraph(XYGraph):
    def __init__(self, x, y, *args, **kwargs):
        ...
        self["data"][0]["line"] = {"color": "rgb(32,139,149)"}
...
class MREMGraph(XYGraph):
    def __init__(self, x, y, *args, **kwargs):
        ...
        self["data"][0]["line"] = {"color": "rgb(102,173,180)"}
...
class MAGraph(XYGraph):
    def __init__(self, x, y, *args, **kwargs):
        ...
        self["data"][0]["line"] = {"color": "rgb(102,146,180)"}
...
class ACGraph(XYGraph):
    def __init__(self, x, y, *args, **kwargs):
        ...
        self["data"][0]["line"] = {"color": "rgb(117,102,180)"}
...
class PRGraph(XYGraph):
    def __init__(self, x, y, *args, **kwargs):
        ...
        self["data"][0]["line"] = {"color": "rgb(100,56,159)"}
...
class CALGraph(XYGraph):
    def __init__(self, x, y, *args, **kwargs):
        ...
        self["data"][0]["line"] = {"color": "rgb(159,56,136)"}
...
class PABSGraph(XYGraph):
    def __init__(self, x, y, *args, **kwargs):
        ...
        self["data"][0]["line"] = {"color": "rgb(215,84,42)"}
...
class PTVGraph(XYGraph):
    def __init__(self, x, y, *args, **kwargs):
        ...
        self["data"][0]["line"] = {"color": "rgb(141,227,183)"}
